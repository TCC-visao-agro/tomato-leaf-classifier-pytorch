...
if __name__ == '__main__':
    ...
    class_sample_count = np.unique(dataset_train, return_counts=True)[1]
    print("foi", class_sample_count)
    ...
    # Loss function.
    weights = [1.03, 2.198, 1.15, 2.309, 1.240, 1.310, 1.564, 1.0, 5.90, 1.373]
